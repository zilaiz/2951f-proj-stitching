...
config_list=( \
    # "cfgs/gciql_pointMmaze_rlkit.yaml" \
    # "cfgs/gciql/gciql_pointMmaze_rlkit_aug05.yaml" \
    # "cfgs/gciql/gciql_pointMmaze_rlkit_aug05_minTogoal10.yaml" \
    "cfgs/gciql/gciql_pointMmaze_rlkit_aug05_minTogoal25.yaml" \
)
